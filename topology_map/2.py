...
ASNS_TO_ZERO = { 3356, 7922, 3257, 174, 209, 701, 4766, 20940, 3320, 4134, 7018, 4837,3320, 4826 }  # AS con criticality sopra il 10%
...
dates = [f"2023-{str(m).zfill(2)}-10" for m in range(12,13)]
